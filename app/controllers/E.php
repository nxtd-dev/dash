...
class E extends CI_Controller
{
	...
	function update()
	{
		...
		if ($this->admin->is_logged()) {
			$file = file_get_contents('https://raw.githubusercontent.com/LightHostingFree/Get Free Website/updates/check.json');
				...
				if ($this->input->get("update")) {
					if ($version > $current) {
						...
						while ($current !== $version) {
							...
							$update = file_get_contents('https://raw.githubusercontent.com/LightHostingFree/Get Free Website/updates/' . $current . '.json');
