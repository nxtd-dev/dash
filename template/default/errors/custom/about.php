...
<head>
	<title>About GetFreeWebsite - <?= $this->base->get_hostname() ?></title>
...
<body class="border-top-wide border-primary d-flex flex-column theme-<?= get_cookie('theme') ?? 'light' ?>">
	<div class="page page-center">
		<div class="container text-center">
			<div class="empty">
				<div class="empty-header"><img src="<?= base_url() ?>assets/<?= $this->base->get_template() ?>/img/gfw.png" class="img-fluid" alt="GetFreeWebsite logo"></div>

				<p class="empty-subtitle" style="max-width: 450px;">GetFreeWebsite is a hosting account and support management system especially designed to work with MyOwnFreeHost and the GoGetSSL API. Please click on the button below to continue the installation.</p>
