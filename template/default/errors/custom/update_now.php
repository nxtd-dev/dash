...
<head>
	<title>Update gfw - <?= $this->base->get_hostname() ?></title>
...
<body class="border-top-wide border-primary d-flex flex-column theme-<?= get_cookie('theme') ?? 'light' ?>">
	<div class="page page-center">
		<div class="container text-center">
			<div class="empty">
				<div class="empty-header"><img src="<?= base_url() ?>assets/<?= $this->base->get_template() ?>/img/gfw.png" alt="gfw logo" class="img-fluid"></div>
